...
import com.admin.oes.Tests_Details.TestDetailsAdapter;
...
String test_name,type,no_of_questions,max_marks,weightage;
...
//        marks.setText(""+weightage);
    ...
    //    ques_no=findViewById(R.id.ques_no);
        ques_no=findViewById(R.id.id_question_number);
    ...
    public void Done(View view) {
        if (question.getText().toString().isEmpty()) {
                    ...
                    DatabaseReference databaseReference2 = FirebaseDatabase.getInstance().getReference("Tests/").child(test_name).child(ques_no.getText().toString());
